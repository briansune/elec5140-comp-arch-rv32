## Generated SDC file "ethernet_test.sdc"
...
create_clock -name {E_TXC} -period 20.000 -waveform { 0.000 10.000 } [get_ports { E_TXC }]
create_clock -name {E_RXC} -period 20.000 -waveform { 0.000 10.000 } [get_ports { E_RXC }]
